...
/*
	/config/fbdev.ini -> FB_BUFFER_LEN=(LV_HOR_RES_MAX * LV_VER_RES_MAX)*4*2/1024
	1024*600 -> FB_BUFFER_LEN=4800
	720*720  -> FB_BUFFER_LEN=4050
*/
#if 0
#define LV_HOR_RES_MAX          (1200)
#define LV_VER_RES_MAX          (1920)
#else
#define LV_HOR_RES_MAX          (320)
#define LV_VER_RES_MAX          (240)
#define LV_MONITOR_ROTATE 	2
/* be careful!!! 16bit dual buffer works not good, let it be 0*/
#define LV_DUAL_FRAMEBUFFER     0
#endif
/* Color depth:
 * - 1:  1 byte per pixel
 * - 8:  RGB233
