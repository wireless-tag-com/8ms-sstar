 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font /root/hmi_esp32/hmi/aliph.ttf -r 0x20-0x7F --symbols 开机画面 --size 16 --format lvgl --bpp 4 --no-compress -o ali_font_16.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t gylph_bitmap[] = {
    ...
    0x7, 0xa0, 0x1, 0xfc, 0xcf, 0xdc, 0xce, 0xdc,
    0xda, 0x0, 0x1f, 0x54, 0x44, 0x44, 0x44, 0x4a,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3864, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 3977, .adv_w = 252, .box_w = 16, .box_h = 16, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4105, .adv_w = 252, .box_w = 15, .box_h = 14, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4210, .adv_w = 252, .box_w = 15, .box_h = 15, .ofs_x = 0, .ofs_y = -2}
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 24320, .range_length = 14435, .glyph_id_start = 96,
